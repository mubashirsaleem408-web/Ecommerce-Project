...
const Collection = () => {
  ...
  // store products in category and type filter
  const applyFilter = () => {
    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t border-gray-200'>
      ...
      <div className='min-w-60'>
        <p onClick={()=>setShowFilter(!showFilter) } className='my-2 text-xl flex items-center gap-2 cursor-pointer'>FILTERS
          <BsArrowRight className={`h-4 sm:hidden ${showFilter ? 'rotate-90' : ''}`} />
            ...
            <div className='flex-1'>
               ...
               <div className='flex justify-between text-base sm:text-2xl mb-4'>
                ...
                <select onChange={(e) => setSortType(e.target.value)} 
                 className='border-1 border-gray-300 text-sm px-2'>
